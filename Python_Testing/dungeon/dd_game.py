'''Dungeon Game
Explore a dungeon to find a hidden door and escape.  But becareful!
...
def build_cells(width, height):
    ...
    >>> cells = build_cells(2, 2)  # what we want to happen
    >>> len(cells)
    4
...
def get_locations(cells):
    ...
    if monster == door or monster == player or door == player:  # recursion
...
def get_moves(player):
    """Based on the tuple of the player's positon, return the list
    of acceptable moves
