...
logging.basicConfig(filename='game.log',
                    level=logging.DEBUG)  # level tells the logger what level to start paying attention to for messages
# will ignore lower levels

# six log levels: Critical, Error, Warning, Info, Debug, and Not Set

# logging.DEBUG sets level to DEBUG
